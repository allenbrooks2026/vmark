...
- **WYSIWYG로 표시할 수 없는 문서:** 인용문이나 목록이 1000단계를 넘게 중첩된 문서는 파일 크기와 관계없이 서식 있는 텍스트로 분석할 수 없습니다. 중첩 깊이를 알려 주는 메시지와 함께 소스 모드로 열리며, 상태 표시줄에 *"소스 모드로 열림(WYSIWYG로 표시할 수 없음)."* 이 표시됩니다. 중첩을 줄인 뒤 **WYSIWYG으로 전환** 을 사용하세요.
