...
- **WYSIWYG で表示できないドキュメント:** 引用やリストが 1000 階層を超えてネストされたドキュメントは、ファイルサイズに関係なくリッチテキストとして解析できません。ネストの深さを示すメッセージとともにソースモードで開き、ステータスバーに *「ソースモードで開きました（WYSIWYG で表示できません）。」* と表示されます。ネストを減らしてから **WYSIWYG に切り替え** を使ってください。
