...
export const DEFAULT_SHORTCUTS: ShortcutDefinition[] = [
  ...
  { id: "toggleTerminalFocus", label: "Toggle Terminal Focus", category: "view", defaultKey: "Mod-Shift-j", description: "Switch keyboard focus between the terminal and the document editor, without closing the terminal" },
